...
public class ExtraNuker extends Module {
	...
	public ExtraNuker() {
		super(Categories.ArtikHack, "extra-nuker", "Breaks a large amount of specified blocks around you.");
	}
	...
	private void onTick(TickEvent.Pre event) {
		...
		try {
			...
			case Save:
				if (isbreak()) {
					ChatUtils.moduleWarning(this,"Р пїЅР Р…РЎРѓРЎвЂљРЎР‚РЎС“Р С�Р ВµР Р…РЎвЂљ Р С—Р С•РЎвЂЎРЎвЂљР С‘ РЎР‚Р В°Р В·РЎР‚РЎС“РЎв‚¬Р ВµР Р…!");
					toggle();
					return;
				}
			case Replace:
