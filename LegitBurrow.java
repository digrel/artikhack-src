...
public class LegitBurrow extends Module {
    ...
    private final Setting<Boolean> onlyInHole = sgGeneral.add(new BoolSetting.Builder()
            .name("only-in-holes")
            .description("Burrowing only in holes.")
            .defaultValue(false)
            .build()
    );
    ...
    private final Setting<Boolean> center = sgGeneral.add(new BoolSetting.Builder()
            .name("CenterTP")
            .description("Teleport character to the center of the block.")
            .defaultValue(true)
            .build()
    );
    ...
    private final Setting<Boolean> rotate = sgGeneral.add(new BoolSetting.Builder()
            .name("rotate")
            .description("Send packets for rotate.")
            .defaultValue(true)
            .build()
    );
    ...
    public LegitBurrow() {
        super(Categories.ArtikHack, "legit-burrow", "Place block inside your hole.");
    }
