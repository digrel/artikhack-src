...
public class CustomAutoCity extends Module {
    ...
    public CustomAutoCity() {
        super(Categories.ArtikHack, "custom-auto-city", "Custom break player's surround.");
    }
    ...
    public void onActivate() {
        ...
        if (target == null || mineTarget == null) {
            if (chatInfo.get()) ChatUtils.moduleError(this, "Target block not found... disabling.");
        } else {
            if (chatInfo.get()) ChatUtils.moduleInfo(this, "Break city " + target.getGameProfile().getName());
            ...
            if (slot == -1) {
                if (chatInfo.get()) ChatUtils.moduleError(this, "Gde kirka?... disabling.");
                toggle();
                return;
            }
